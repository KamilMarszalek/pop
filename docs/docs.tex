...
natomiast zostało użyte już $k$ kart. Wówczas:
\[
DP[i][p][k] =
\begin{cases}
...
W eksperymentach porównamy jakość i czas działania zaproponowanych algorytmów na zestawie instancji o różnych rozmiarach planszy i liczbie kart. Pola planszy zostaną zainicjowane wartościamu z różnych przedziałów (np. $[-100, 100]$, $[-1000, 1000]$) aby ocenić wpływ rozkładu wartości na efektywność algorytmów.
\end{document}
